...
class WriterCache:
    ...
    def __init__(self, outdir, calls, linktype, max_open=64):
...
def split_pcap(pcap, calls, index_file, outdir, max_open):
    ...
    input_linktype = reader.linktype

    print("      Input PCAP linktype:", input_linktype)

    writers = WriterCache(outdir, calls, input_linktype, max_open)
